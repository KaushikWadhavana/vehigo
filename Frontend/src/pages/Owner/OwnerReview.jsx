...
import { MoreVertical, Eye, Trash2,  Home, Car, Filter, ArrowUpDown, LayoutList} from "lucide-react";
...
{/* ===== TOP BAR ===== */}
<div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 px-6 py-8 text-center">
  ...
  <p className="text-gray-500 mt-2 text-sm">
    Manage and track all your vehicle reviews easily
  </p>
...
<div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6">
{/* ===== SECTION HEADER ===== */}
<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">

  {/* LEFT */}
  <p className="text-sm text-gray-500">
    Manage and track all your vehicle reviews
  </p>
  ...
  <div className="flex flex-wrap items-center gap-3">
    ...
    <select
      ...
      className="bg-white border border-gray-300 px-4 py-2 rounded-xl shadow-sm text-sm focus:ring-2 focus:ring-teal-500"
    >
...
<div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-3">
  ...
  <h2 className="text-lg font-semibold text-gray-800">
    Vehicle Reviews ({filtered.length})
  </h2>
