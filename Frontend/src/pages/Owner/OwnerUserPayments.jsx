...
<div className="flex items-center gap-3 min-w-[260px]">      <img
  ...
  {/* USER */}
  <td className="p-3 whitespace-nowrap">
<div className="flex items-center gap-3 min-w-[200px]">      <img
        src={p.userImage}
  ...
  {/* PAYMENT STATUS */}
<td className="p-3 whitespace-nowrap w-[120px]">    <span
      className={`px-3 py-1 text-xs rounded-full inline-block ${getStatusStyle(
...
<span
  className={`px-3 py-1 text-xs rounded-full inline-flex items-center gap-1 ${getBookingStyle(
    p.bookingStatus
  )}`}
>
{p.bookingStatus === "Completed" && <CheckCircle size={12} />}
{p.bookingStatus === "Cancelled" && <XCircle size={12} />}
{p.bookingStatus === "Rejected" && <XCircle size={12} />}
{p.bookingStatus === "Upcoming" && <ChevronRight size={12} />}
{p.bookingStatus === "In Progress" && <ArrowUpDown size={12} />}  {p.bookingStatus}
</span>
  </td>
