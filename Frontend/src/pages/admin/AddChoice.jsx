...
export default function AddChoice() {
  ...
  return (
<div className="space-y-6 px-4 min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">      <button     onClick={() => navigate("/admin")}
      className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 hover:text-orange-500 transition">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <button
            ...
            className="border rounded-xl p-6 flex gap-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition"
          >
