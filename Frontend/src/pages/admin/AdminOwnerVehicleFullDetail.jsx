...
export default function AdminOwnerVehicleFullDetail() {
...
const openDoc = (url) => {
  ...
  return (
<div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-10 transition-colors"><button
  onClick={() => navigate(-1)}
  className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-orange-500 mb-8 transition"
>
  <ArrowLeft size={18} />
  Back to Vehicles
</button>
        ...
        <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl shadow-lg border dark:border-gray-800 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            {vehicle.features.map((f, i) => (
              <span
                key={i}
                className="px-4 py-2 bg-orange-100 dark:bg-orange-900 text-orange-600 dark:text-orange-300 rounded-full text-sm"
              >
                {f}
              </span>
            ))}
